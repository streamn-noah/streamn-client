...
export function LowDataToggle() {
  ...
  return (
    <button
      ...
      className={`fixed bottom-24 right-4 md:bottom-28 md:right-6 z-[100] flex items-center justify-center gap-2 px-3 py-2 rounded-full backdrop-blur-xl border transition-all duration-300 group shadow-2xl ${isLowDataMode
